...
void scale_riscv_scale_f32(void)
{
    ...
    zircon_result_zero_f32(scale_f32_output, (uint32_t)(sizeof(scale_f32_output) / sizeof(scale_f32_output[0])));
BENCH_START(riscv_scale_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, scale_f32_input, (uint32_t)sizeof(scale_f32_input));
    __zr_hash = zircon_result_hash_combine(__zr_hash, &scale_f32, (uint32_t)sizeof(scale_f32));
