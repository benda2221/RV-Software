...
void mul_riscv_mul_f32(void)
{
    ...
    zircon_result_zero_f32(mult_f32_output, (uint32_t)(sizeof(mult_f32_output) / sizeof(mult_f32_output[0])));
BENCH_START(riscv_mult_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, mult_f32_input1, (uint32_t)sizeof(mult_f32_input1));
    __zr_hash = zircon_result_hash_combine(__zr_hash, mult_f32_input2, (uint32_t)sizeof(mult_f32_input2));
