...
void abs_riscv_abs_f32(void)
{
    ...
    zircon_result_zero_f32(abs_f32_output, (uint32_t)(sizeof(abs_f32_output) / sizeof(abs_f32_output[0])));
BENCH_START(riscv_abs_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, abs_f32_output, (uint32_t)sizeof(abs_f32_output));
    __zr_hash = zircon_result_hash_combine(__zr_hash, abs_f32_input, (uint32_t)sizeof(abs_f32_input));
    printf("@@RESULT@@ case=abs_riscv_abs_f32 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}
