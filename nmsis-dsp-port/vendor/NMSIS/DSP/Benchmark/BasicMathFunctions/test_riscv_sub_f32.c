...
BENCH_START(riscv_sub_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, sub_f32_input1, (uint32_t)sizeof(sub_f32_input1));
    __zr_hash = zircon_result_hash_combine(__zr_hash, sub_f32_input2, (uint32_t)sizeof(sub_f32_input2));
