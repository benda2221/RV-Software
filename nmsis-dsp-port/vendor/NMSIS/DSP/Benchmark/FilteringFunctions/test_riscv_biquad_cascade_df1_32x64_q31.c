...
void df1_riscv_biquad_cas_df1_32x64_q31(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, biquad_cas_df1_32x64_q31_output, (uint32_t)sizeof(biquad_cas_df1_32x64_q31_output));
    printf("@@RESULT@@ case=df1_riscv_biquad_cas_df1_32x64_q31 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}
