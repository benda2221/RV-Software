...
void convPartial_riscv_conv_partial_q15(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, conv_partial_q15_output + firstIndex, (uint32_t)(numPoints * sizeof(conv_partial_q15_output[0])));
    __zr_hash = zircon_result_hash_combine(__zr_hash, &result, (uint32_t)sizeof(result));
    printf("@@RESULT@@ case=convPartial_riscv_conv_partial_q15 hash=0x%08x\n", (unsigned int)__zr_hash);
