...
void conv_riscv_conv_fast_q15(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, conv_fast_q15_output, (uint32_t)((ARRAYA_SIZE_Q15 + ARRAYB_SIZE_Q15 - 1u) * sizeof(conv_fast_q15_output[0])));
    printf("@@RESULT@@ case=conv_riscv_conv_fast_q15 hash=0x%08x\n", (unsigned int)__zr_hash);
}