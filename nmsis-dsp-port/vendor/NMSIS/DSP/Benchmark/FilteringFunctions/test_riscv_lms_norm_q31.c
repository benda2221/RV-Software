...
void lmsNorm_riscv_lms_norm_q31(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, lms_norm_q31_output, (uint32_t)sizeof(lms_norm_q31_output));
    printf("@@RESULT@@ case=lmsNorm_riscv_lms_norm_q31 hash=0x%08x\n", (unsigned int)__zr_hash);
}
