...
void sin_riscv_sin_f32(void)
{
    ...
    zircon_result_zero_f32(sin_f32_output, (uint32_t)(sizeof(sin_f32_output) / sizeof(sin_f32_output[0])));
BENCH_START(riscv_sin_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, sin_f32_input, (uint32_t)sizeof(sin_f32_input));
