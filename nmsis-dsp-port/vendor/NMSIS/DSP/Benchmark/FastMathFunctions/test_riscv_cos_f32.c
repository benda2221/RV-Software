...
void cos_riscv_cos_f32(void)
{
    ...
    zircon_result_zero_f32(cos_f32_output, (uint32_t)(sizeof(cos_f32_output) / sizeof(cos_f32_output[0])));
BENCH_START(riscv_cos_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cos_f32_output, (uint32_t)sizeof(cos_f32_output));
    __zr_hash = zircon_result_hash_combine(__zr_hash, cos_f32_input, (uint32_t)sizeof(cos_f32_input));
    printf("@@RESULT@@ case=cos_riscv_cos_f32 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}