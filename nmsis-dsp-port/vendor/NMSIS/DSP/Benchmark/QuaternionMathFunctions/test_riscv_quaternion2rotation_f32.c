...
BENCH_START(riscv_quaternion2rotation_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, quaternion2rotation_f32_input, (uint32_t)sizeof(quaternion2rotation_f32_input));
    printf("@@RESULT@@ case=quaternion2Rotation_riscv_quaternion2rotation_f32 hash=0x%08x\n", (unsigned int)__zr_hash);
}
