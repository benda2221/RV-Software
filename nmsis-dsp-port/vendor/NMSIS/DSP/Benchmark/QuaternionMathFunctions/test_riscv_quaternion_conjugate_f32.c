...
BENCH_START(riscv_quaternion_conjugate_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, quat_conj_f32_input, (uint32_t)sizeof(quat_conj_f32_input));
    printf("@@RESULT@@ case=quaternionConjugate_riscv_quaternion_conjugate_f32 hash=0x%08x\n", (unsigned int)__zr_hash);
}
