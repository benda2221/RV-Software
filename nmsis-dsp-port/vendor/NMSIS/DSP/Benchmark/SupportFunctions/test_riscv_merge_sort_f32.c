...
BENCH_START(riscv_merge_sort_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, f32_out_array, (uint32_t)sizeof(f32_out_array));
    __zr_hash = zircon_result_hash_combine(__zr_hash, merge_sort_f32_input, (uint32_t)sizeof(merge_sort_f32_input));
