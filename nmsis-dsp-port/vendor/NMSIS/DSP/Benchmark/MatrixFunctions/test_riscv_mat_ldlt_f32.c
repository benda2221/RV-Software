...
BENCH_START(riscv_mat_ldlt_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, mat_ldlt_f32_input, (uint32_t)sizeof(mat_ldlt_f32_input));
    __zr_hash = zircon_result_hash_combine(__zr_hash, f32_e_array, (uint32_t)sizeof(f32_e_array));
