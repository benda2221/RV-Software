...
BENCH_START(riscv_mat_solve_upper_triangular_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, mat_su_f32_input, (uint32_t)sizeof(mat_su_f32_input));
    __zr_hash = zircon_result_hash_combine(__zr_hash, mat_ut, (uint32_t)sizeof(mat_ut));
