...
void jensenshannon_distance_riscv_jensenshannon_distance_f32(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, jensenshannon_distance_f32_input1, (uint32_t)sizeof(jensenshannon_distance_f32_input1));
    __zr_hash = zircon_result_hash_combine(__zr_hash, jensenshannon_distance_f32_input2, (uint32_t)sizeof(jensenshannon_distance_f32_input2));
