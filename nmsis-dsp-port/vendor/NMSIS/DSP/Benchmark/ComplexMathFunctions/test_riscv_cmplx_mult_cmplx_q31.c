...
void cmplx_mult_cmplx_riscv_cmplx_mult_cmplx_q31(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_mult_cmplx_q31_output, (uint32_t)sizeof(cmplx_mult_cmplx_q31_output));
    printf("@@RESULT@@ case=cmplx_mult_cmplx_riscv_cmplx_mult_cmplx_q31 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}
