...
void cmplx_mult_cmplx_riscv_cmplx_mult_cmplx_f32(void)
{
    ...
    zircon_result_zero_f32(cmplx_mult_cmplx_f32_output, (uint32_t)(sizeof(cmplx_mult_cmplx_f32_output) / sizeof(cmplx_mult_cmplx_f32_output[0])));
BENCH_START(riscv_cmplx_mult_cmplx_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_mult_cmplx_f32_input1, (uint32_t)sizeof(cmplx_mult_cmplx_f32_input1));
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_mult_cmplx_f32_input2, (uint32_t)sizeof(cmplx_mult_cmplx_f32_input2));
