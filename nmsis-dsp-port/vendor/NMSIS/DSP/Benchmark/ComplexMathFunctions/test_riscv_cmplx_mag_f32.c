...
void cmplx_mag_riscv_cmplx_mag_f32(void)
{
    ...
    zircon_result_zero_f32(cmplx_mag_f32_output, (uint32_t)(sizeof(cmplx_mag_f32_output) / sizeof(cmplx_mag_f32_output[0])));
BENCH_START(riscv_cmplx_mag_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_mag_f32_output, (uint32_t)sizeof(cmplx_mag_f32_output));
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_mag_f32_input, (uint32_t)sizeof(cmplx_mag_f32_input));
