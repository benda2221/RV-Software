...
void cmplx_conj_riscv_cmplx_conj_q15(void)
{
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_conj_q15_output, (uint32_t)sizeof(cmplx_conj_q15_output));
    printf("@@RESULT@@ case=cmplx_conj_riscv_cmplx_conj_q15 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}
