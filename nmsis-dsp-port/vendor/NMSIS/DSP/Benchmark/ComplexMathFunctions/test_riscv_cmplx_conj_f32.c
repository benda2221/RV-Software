...
void cmplx_conj_riscv_cmplx_conj_f32(void)
{
    ...
    zircon_result_zero_f32(cmplx_conj_f32_output, (uint32_t)(sizeof(cmplx_conj_f32_output) / sizeof(cmplx_conj_f32_output[0])));
BENCH_START(riscv_cmplx_conj_f32);
    ...
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_conj_f32_output, (uint32_t)sizeof(cmplx_conj_f32_output));
    __zr_hash = zircon_result_hash_combine(__zr_hash, cmplx_conj_f32_input, (uint32_t)sizeof(cmplx_conj_f32_input));
    printf("@@RESULT@@ case=cmplx_conj_riscv_cmplx_conj_f32 hash=0x%08x\n", (unsigned int)__zr_hash);
return;
}
