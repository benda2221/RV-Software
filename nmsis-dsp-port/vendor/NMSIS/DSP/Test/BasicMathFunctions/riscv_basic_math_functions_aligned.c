...
/*
 * The scalar logical implementations process eight bytes per iteration by
 * casting these buffers to uint64_t pointers.  Keep every individual buffer
 * eight-byte aligned: ARRAY_SIZE is deliberately odd, so aligning only the
 * first declaration is insufficient for the following arrays.
 */
#define TEST_BUFFER_ALIGNED __attribute__((aligned(8)))

float32_t f32_a_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
float32_t f32_b_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
float32_t f32_out_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
float32_t f32_out_ref_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q7_t q7_a_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q7_t q7_b_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q7_t q7_out_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q7_t q7_out_ref_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q15_t q15_a_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q15_t q15_b_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q15_t q15_out_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q15_t q15_out_ref_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q31_t q31_a_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q31_t q31_b_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q31_t q31_out_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
q31_t q31_out_ref_array[ARRAY_SIZE] TEST_BUFFER_ALIGNED;
